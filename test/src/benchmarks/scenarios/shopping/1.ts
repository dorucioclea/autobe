...
export const scenario: IScenario = {
  name: "shopping-system-1",
  requirements: {
    analyze:
      "I want to create a shopping-mall system. Since I'm not familiar with programming, please write a requirements analysis report as you see fit.",
    prisma:
