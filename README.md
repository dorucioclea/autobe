...
When `@autobe` agent writes some program codes, they would be stored under the `playground-result` directory.
...
![AutoBE Generated Backend Application Example](https://github.com/user-attachments/assets/65e2f63d-5112-4b85-9197-29fc04299d10)
